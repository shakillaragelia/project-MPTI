  ...
  <section id="product" class="product">
      <div class="product-display">
          ...
          <div class="product-details">
              ...
              <div class="price">
                <span id="product-price">Rp 75.000</span> IDR
              </div>
              <div class="options">
              ...
              <a href="{{route('dashboard.beli')}}" class="add-to-cart" data-product-type="premium">Beli Sekarang <i class="fa-solid fa-cart-shopping fa-bounce"></i></a>
